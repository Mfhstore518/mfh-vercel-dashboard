...
<body>
    <h1>🛒 CUSTOMER WEBSTORE COMING SOON!</h1>
...
if __name__ == "__main__":
    ...
    print("🚀 MFH Complete System running on http://localhost:8080")
